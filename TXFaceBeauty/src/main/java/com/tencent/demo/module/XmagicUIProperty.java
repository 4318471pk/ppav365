...
public class XmagicUIProperty<V> {
     ...
     * @param value
     */
    public XmagicUIProperty(UICategory category, String displayName, String id, String resPath, int thumbDrawable, String effKey, V value) {
     ...
     */
    public XmagicUIProperty(UICategory category, String displayName, String id, String resPath, int thumbDrawable, String effKey, V value, String rootDisplayName) {
        property = new XmagicProperty<>(category.getXmagicCategory(), id, resPath, effKey, value);
        this.displayName = displayName;
        this.thumbDrawable = thumbDrawable;
        this.uiCategory = category;
