...
public class UserDetailActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        if (uid == AppUserManger.getUserInfo().getUid()) {
    ...
    public void refreshPage(String userJson, Context context) {
        ...
        if (AppUserManger.getUserInfo().getUid() == user.getUid()) {
            btnFollow.setVisibility(View.GONE);
            btnLetter.setVisibility(View.GONE);
        } else {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tvEditInfo:
                EditUserInfoActivity.startActivity(this, AppUserManger.getUserInfo().getPhone());
                break;
        }
    }
}
