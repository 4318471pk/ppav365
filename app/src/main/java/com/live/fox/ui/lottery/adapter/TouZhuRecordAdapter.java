...
public class TouZhuRecordAdapter extends BaseQuickAdapter<String, BaseViewHolder> {


    public TouZhuRecordAdapter(List data) {
        super(R.layout.item_touzhu_record, data);
    }
