        ...
        Api_User.ins().withdraw(bankInfo.getCardId(), 1, coin, cashPassword, pageType, new JsonCallback<String>() {
            ...
            public void onSuccess(int code, String msg, String data) {
                ...
                if (code == 0) {
                    User user=new User();
                    if (pageType == 1) {
                        myUserInfo.setGoldCoin(myUserInfo.getGoldCoin() - coin / Float.parseFloat(AppConfig.getExchangeRatio()));
                        user.setGoldCoin(myUserInfo.getGoldCoin());
                    } else {
                        myUserInfo.setAnchorCoin(myUserInfo.getAnchorCoin() - coin / Float.parseFloat(AppConfig.getExchangeRatio()));
                        user.setAnchorCoin(myUserInfo.getAnchorCoin());
                    }
