...
public class NearByPeopleListAdapter extends BaseQuickAdapter<RoomListBean, BaseViewHolder> {
    int itemWidth;
    Context context;
    ...
    public NearByPeopleListAdapter(Context context, List<RoomListBean> data) {
