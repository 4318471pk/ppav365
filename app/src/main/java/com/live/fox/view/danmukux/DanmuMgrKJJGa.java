...
public class DanmuMgrKJJGa {

    private Context mContext;
    private DanmuKJJGViewa mDanmuContainerView;
    ...
    public DanmuMgrKJJGa(Context context) {
     ...
     */
    public void setDanmakuView(DanmuKJJGViewa danmakuView) {
    ...
    private void initDanmuView() {
        ...
        mDanmuContainerView.setSpeed(DanmuKJJGViewa.NORMAL_SPEED);
    }

    DanmuConverter<DanmuEntity> danmuConverter = new DanmuConverter<DanmuEntity>() {
        @Override
        ...
        public View convert(DanmuEntity model) {
            ...
            if (model.getType() == 15) { //直播间cp
                ...
                LinearLayout llAllResult = view.findViewById(R.id.llAllResult);
                TextView numa = view.findViewById(R.id.numpa);
                TextView numb = view.findViewById(R.id.numpb);
                TextView numc = view.findViewById(R.id.numpc);
                TextView numd = view.findViewById(R.id.numpd);
                TextView nume = view.findViewById(R.id.numpe);
                TextView numf = view.findViewById(R.id.numpf);
                TextView numg = view.findViewById(R.id.numpg);
                TextView numh = view.findViewById(R.id.numph);
                TextView numi = view.findViewById(R.id.numpi);
                TextView numj = view.findViewById(R.id.numpj);
                ...
                if (lotteryResultList != null && lotteryResultList.size() != 0) {
                    ...
                    if ("txssc".equals(lsResult.getName())) {
                        for (int i = 0; i < lotteryResultList.size(); i++) {
                            switch (i) {
                                case 0:
                                    numa.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 1:
                                    numb.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 2:
                                    numc.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 3:
                                    numd.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 4:
                                    nume.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                            }
                        }
                        ...
                        for (int i = 0; i < lotteryResultList.size(); i++) {
                            switch (i) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    numf.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 6:
                                    numg.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 7:
                                    numh.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 8:
                                    numi.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                                case 9:
                                    numj.setText(String.valueOf(lotteryResultList.get(i)));
                                    break;
                            }
                        }
                ...
                iv_colse.setOnClickListener(view1 -> reWhole.setVisibility(View.GONE));
            }
            return view;
        }
    };
