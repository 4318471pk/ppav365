...
public class ClassicsFooter extends InternalClassics<ClassicsFooter>
    ...
    public ClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, DeviceUtils.dp2px(context, 20));
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlDrawableArrow)) {
            ...
            mArrowDrawable.setColor(0xffffff);
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlDrawableProgress)) {
            ...
            mProgressDrawable.setColor(0xffffff);
