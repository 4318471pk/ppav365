...
public class GestureLockLayout extends RelativeLayout {
    ...
    private void init(final Context context) {
        mStrokeWidth=ScreenUtils.getDip2px(getContext(),5);
        ...
        mPaint.setStrokeWidth(ScreenUtils.getDip2px(context, mStrokeWidth));
    ...
    public void setPathWidth(float dp) {
        mPaint.setStrokeWidth(ScreenUtils.getDip2px(getContext(), dp));
    }
