...
//        }
        ...
        Path path=new Path();
        path.addRoundRect(new RectF(0,0,getRectLength(circleRectF),getRectLength(circleRectF)),0,0, Path.Direction.CW);
...
//        float circleRectFLength=rectFW>rectFH?rectFH:rectFW;
        float circleRectFLength= ScreenUtils.getScreenWidth(getContext())-ScreenUtils.dp2px(getContext(),10);
        //计算出圆形所在矩阵的left top
