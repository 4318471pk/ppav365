...
public class SoftLinearLayout extends LinearLayout {
    ...
    protected void onWindowVisibilityChanged(int visibility) {
        ...
        if (visibility == GONE) {
            SPUtils.getInstance().put(SP_KEY_SECOND_HEIGHT,secondChildHeight);
        }
    }
    ...
    private void init() {
        ...
        secondChildHeight = SPUtils.getInstance().getInt(SP_KEY_SECOND_HEIGHT, DEFAULT_SECOND_CHILD_HEIGHT);
    }
