 ...
 * Time: 09:47
 */
public class LiveRoomBanner extends ConvenientBanner {

    public LiveRoomBanner(Context context) {
        this(context, null);
    }

    public LiveRoomBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LiveRoomBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setData(Context context, List<Advert> bannerList) {
        ...
        this.setPages(ImageHolder::new, bannerList)
...
//                    H5Activity.start(context, "", bannerList.get(position).getJumpUrl());
    ...
    public class ImageHolder implements Holder<Advert> {
        ...
        public View createView(Context context) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_liveroom_banner, null);
