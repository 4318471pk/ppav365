...
public class MyWaterDropView extends View {
    ...
    public MyWaterDropView(Context context) {
        ...
        mPaint.setColor(Color.GRAY);
        mMaxCircleRadius = SmartUtil.dp2px(15);
    ...
    public ValueAnimator createAnimator() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator1) {
                MyWaterDropView.this.updateCompleteState((float) valueAnimator1.getAnimatedValue());
                final View thisView = MyWaterDropView.this;
