...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundTextColor, Color.TRANSPARENT);
        textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_roundTextSize, 15);
        roundWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_roundWidth, 5);
        max = mTypedArray.getInteger(R.styleable.RoundProgressBar_max, 100);
        drawDot = mTypedArray.getBoolean(R.styleable.RoundProgressBar_drawDot, false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawDot) {
            ...
            canvas.drawArc(oval, -54, 4, false, paint);
        }
    }
