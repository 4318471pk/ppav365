...
public class ViewPagerAllResponse extends ViewPager {
    ...
    private final static float DISTANCE = 1;//默认距离
    private float downX;
    private float downY;
    private float upX;
    private float upY;
    ...
    private View clickPageOnScreen(MotionEvent ev) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (position < currentIndex) {
                ...
                maxX -= v.getWidth() * (1 - PromoMaterialActivity.ZoomOutPageTransformer.MIN_SCALE) * 0.5;
                minX -= v.getWidth() * (1 - PromoMaterialActivity.ZoomOutPageTransformer.MIN_SCALE) * 0.5;
            }
