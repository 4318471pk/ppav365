 ...
 * 版权申明: 暂无
 */
public class FloatViewmv implements View.OnTouchListener {
    ...
    private static int mPrevPositionX, mPrevPositionY = 120;
    ...
    private FloatViewmv(Builder builder) {
        mBuilder = builder;
        initFloatView();
    }
    ...
    public boolean getBottomRight() {
        return mBuilder.bottomRight;
    }

    public int getMarginBottom() {
        return mBuilder.marginBottom;
    }
    ...
    /*    Rect frame = new Rect();
        ...
        int top = mStatusBarHeight + mPrevPositionY;
        if (getBottomRight()) {
            if (getMarginBottom() < 0) {
                layoutParams = createLayoutParams(left, top, 0, DensityUtils.dp2px(getActivity(), 100));
            } else {
                layoutParams = createLayoutParams(left, top, 0, DensityUtils.dp2px(getActivity(), getMarginBottom()));
            }

            layoutParams.gravity = Gravity.END | Gravity.BOTTOM;
        } else {
            layoutParams = createLayoutParams(left, top, 0, 0);
        }
    ...
    private static FloatViewmv createFloatView(Builder builder) {
        if (null == builder) {
        ...
        return new FloatViewmv(builder);
    }
    ...
    public static class Builder {
        ...
        public Builder setBottomRight(boolean bottomRight) {
            this.bottomRight = bottomRight;
            return this;
        }

        public Builder setMarinBottom(int bottom) {
            this.marginBottom = bottom;
            return this;
        }

        public FloatViewmv build() {
