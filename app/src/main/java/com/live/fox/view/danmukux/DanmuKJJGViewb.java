...
public class DanmuKJJGViewb extends ViewGroup {
    ...
    private DanmuMgrKJJGb luck;

    public DanmuKJJGViewb(Context context) {
        this(context, (AttributeSet) null, 0);
    }

    public DanmuKJJGViewb(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DanmuKJJGViewb(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == 0) {
                    ...
                    view = (View) msg.obj;
                    view.offsetLeftAndRight(0 - DanmuKJJGViewb.this.speed);
                } else if (msg.what == 2) {
                    view = (View) msg.obj;
                    DanmuKJJGViewb.this.removeView(view);
                } else if (msg.what == 110) {
                    TextView content = null;
                    View var = DanmuKJJGViewb.this.findViewById(R.id.content);
    ...
    public void setLeader(DanmuMgrKJJGb luck) {
        this.luck = luck;
    }
    ...
    public <M> void addDanmu(final M model) throws Error {
        if (this.danmuConverter == null) {
            ...
            danmuView.setOnClickListener(v -> {
                if (DanmuKJJGViewb.this.onItemClickListener != null) {
                    DanmuKJJGViewb.this.onItemClickListener.onItemClick(model);
                }
            });
        }
    }
    ...
    private class MyRunnable implements Runnable {
        ...
        public void run() {
            ...
            while (tempX >= 0.0F) {
                tempX = this.view.getX() + childWidth;//*2
                try {
        ...
        private void slideMessage(int i, boolean isDelay) {
            Message msg;
            msg = Message.obtain(DanmuKJJGViewb.this.handler);
            msg.obj = this.view;
            msg.what = i;
            if (isDelay) DanmuKJJGViewb.this.handler.sendMessageDelayed(msg, 800);
            else DanmuKJJGViewb.this.handler.sendMessage(msg);
        }
    }
