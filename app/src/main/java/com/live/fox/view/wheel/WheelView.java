...
package com.live.fox.view.wheel;
...
import com.live.fox.view.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	 ...
	 * @param resource
	 */
	public void setWheelCenterDrawable(int resource) {
		centerDrawable = getContext().getResources().getDrawable(resource);
	}
	...
	private void initResourcesIfNecessary() {
		if (centerDrawable == null) {
			centerDrawable = new ColorDrawable(0xfff4f1f8);
		}
