...
public class LHCDialogFragment extends DialogFragment {
    ...
    public static LHCDialogFragment newInstance(String lotteryName, String nickName) {
        LHCDialogFragment fragment = new LHCDialogFragment();
    ...
    public void setRecycleView() {
        ...
        rv.setAdapter(adapter = new BaseQuickAdapter(R.layout.item_history_lhc, new ArrayList<LsResult>()) {
            @Override
            protected void convert(BaseViewHolder helper, Object item) {
                ...
                helper.setText(R.id.numf,lotteryResult.get(5)+"");
                TextView numg=helper.getView(R.id.numg);
                numg.setText(lotteryResult.get(6) + "");
                if (3 == lotteryResult.get(7)) {
                    numg.setBackgroundResource(R.drawable.prizer_num_bg_blue);
                } else if (2 == lotteryResult.get(7)) {
                    numg.setBackgroundResource(R.drawable.prizer_num_bg_green);
                } else {
                    numg.setBackgroundResource(R.drawable.prizer_num_bg_red);
                }
            }
        });
