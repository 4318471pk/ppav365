...
public class KSDialogFragment extends DialogFragment {
    ...
    public static KSDialogFragment newInstance(String lotteryName,String nickName) {
        KSDialogFragment fragment = new KSDialogFragment();
    ...
    public void choicePis(TextView textView, int item) {
        if (1 == item) {
