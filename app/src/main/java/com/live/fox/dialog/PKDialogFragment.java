...
public class PKDialogFragment extends DialogFragment {
    ...
    public static PKDialogFragment newInstance(String lotteryName, String nickName) {
        PKDialogFragment fragment = new PKDialogFragment();
    ...
    public void setRecycleView() {
        ...
        rv.setAdapter(adapter = new BaseQuickAdapter(R.layout.item_history_ssc, new ArrayList<LsResult>()) {
            ...
            protected void convert(BaseViewHolder helper, Object item) {
                ...
                helper.setText(R.id.numg,lotteryResult.get(6)+"");
                helper.setText(R.id.numh,lotteryResult.get(7)+"");
                helper.setText(R.id.numi,lotteryResult.get(8)+"");
                helper.setText(R.id.numj,lotteryResult.get(9)+"");
            }
        });
