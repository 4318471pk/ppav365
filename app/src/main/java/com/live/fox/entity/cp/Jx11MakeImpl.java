...
public class Jx11MakeImpl implements CpMake {
...
//        混合  大 小 单 双 大单 小单 大双 小双 极大 极小
        if (index == 0) {
            tab.setTabTitle(context.getString(R.string.anyCompound));
            tab.tabType = 1;
            tab.setLimit(1);
            tab.type = "13.1";
            ...
            tab.setTabTitle(context.getString(R.string.renErDuplex));
            tab.tabType = 1;
            tab.setLimit(2);
            tab.type = "1.1";
            ...
            tab.setTabTitle(context.getString(R.string.renSanDuplex));
            tab.tabType = 1;
            tab.setLimit(3);
            tab.type = "2.1";
