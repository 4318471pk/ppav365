...
public class MyTouzuBean implements Serializable {
    ...
    private int times;
    private MyTouzuBean.PlayNumReqBean playNumReq;
    ...
    public MyTouzuBean.PlayNumReqBean getPlayNumReq() {
        return playNumReq;
    }

    public void setPlayNumReq(MyTouzuBean.PlayNumReqBean playNumReq) {
