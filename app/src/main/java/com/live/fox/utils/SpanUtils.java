...
/**
 ...
 spanUtils.append("大把").setForegroundColor(Color.parseColor("#F0668A"));
 spanUtils.append("兑换成金币").setForegroundColor(Color.BLACK);
 com.live.fox.helper.setText(R.id.tv_des, spanUtils.create());
