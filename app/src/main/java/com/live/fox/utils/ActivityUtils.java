...
public final class ActivityUtils {
    ...
    public static void startActivityWithSlideAnim(final Class<?> clz) {
        startActivity(clz, R.anim.slide_left_in, R.anim.slide_right_out);
    }

    public static void startActivityWithSlideAnim(@NonNull final Intent intent) {
        startActivity(intent, R.anim.slide_left_in, R.anim.slide_right_out);
    }

    public static void startActivityWithBottomSlideAnim(@NonNull final Intent intent) {
        startActivity(intent, R.anim.slide_bottom_in, 0);
    }
    ...
    public static Activity getTopActivity() {
        if (!Utils.getActivityList().isEmpty()) {
