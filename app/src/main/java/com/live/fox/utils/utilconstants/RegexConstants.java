package com.live.fox.utils.utilconstants;
...
public final class RegexConstants {
    ...
    //过滤字母和数字  https://blog.csdn.net/baidu_35468322/article/details/83056136
    public static final String REGEX_PASSWORD = "[0-9A-Za-z]+";
    /**
     * Regex of date which pattern is "dd-MM-yyyy".
     */
