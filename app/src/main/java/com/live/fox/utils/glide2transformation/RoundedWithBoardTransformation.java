package com.live.fox.utils.glide2transformation;
...
public class RoundedWithBoardTransformation extends BitmapTransformation {
  ...
  public RoundedWithBoardTransformation(int radius, @ColorInt int borderColor) {
    this(radius, 0, CornerType.ALL, 1, borderColor);
  }


  public RoundedWithBoardTransformation(int radius, int margin, int borderWidth, @ColorInt int borderColor) {
    this(radius, margin, CornerType.ALL, borderWidth, borderColor);
  }

  public RoundedWithBoardTransformation(int radius, int margin, CornerType cornerTyp, int borderWidth, @ColorInt int borderColor) {
    this.radius = radius;
    this.diameter = this.radius * 2;
    this.margin = margin;
    this.cornerType = cornerTyp;
  ...
  protected Bitmap transform(@NonNull BitmapPool pool, @NonNull Bitmap toTransform, int outWidth, int outHeight) {
    ...
    if (mBorderPaint != null) {
      ...
      canvas.drawRoundRect(new RectF(0 + mBorderWidth/2, 0 + mBorderWidth/2, width - mBorderWidth/2, height - mBorderWidth/2), borderRadius, borderRadius, mBorderPaint);
    }
    return bitmap;
  }
  ...
  public boolean equals(Object o) {
    return o instanceof RoundedWithBoardTransformation &&
        ((RoundedWithBoardTransformation) o).radius == radius &&
        ((RoundedWithBoardTransformation) o).diameter == diameter &&
        ((RoundedWithBoardTransformation) o).margin == margin &&
        ((RoundedWithBoardTransformation) o).cornerType == cornerType;
  }
