...
public class LocalMedia implements Parcelable {
    ...
    private int width;
    private int height;
    private boolean isReadBag = false;
    ...
    public boolean isReadBag() {
        return isReadBag;
    }

    public void setReadBag(boolean readBag) {
        isReadBag = readBag;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeByte(this.isReadBag ? (byte) 1 : (byte) 0);
    }
